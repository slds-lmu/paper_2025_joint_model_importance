...
% Rashomon set — no macro exists in latex-math; carries an
% epsilon subscript to disambiguate from \risk (= \mathcal{R}).
\newcommand{\Rset}{\mathcal{R}_\varepsilon}
...
\begin{frame}{Beyond the single best model}
  \begin{itemize}
    ...
    \item For a tolerance $\varepsilon$, the \emph{Rashomon set}
      \[
        \Rset \;=\; \bigl\{\, \fhDlam \,:\, \mathrm{score}(\fhDlam) \le \mathrm{score}(\fhDlams) \cdot (1+\varepsilon),\ \lamv \in \Lam \,\bigr\}
      \]
