...
\begin{frame}{MDS view --- all four tasks}
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.42\textwidth]{../figures/mds_gc_euclidean.pdf} &
    \includegraphics[width=0.42\textwidth]{../figures/mds_cs_euclidean.pdf} \\[0.5ex]
    \includegraphics[width=0.42\textwidth]{../figures/mds_bs_euclidean.pdf} &
    \includegraphics[width=0.42\textwidth]{../figures/mds_st_euclidean.pdf} \\
  \end{tabular}
\end{frame}
...
\begin{frame}{Within-family structure I --- \texttt{st}\,/\,\texttt{nnet}}
  \centering
  \includegraphics[width=0.82\textwidth]{../figures/hp_trajectories/hp_vs_mds1_st_nnet.pdf}\\[0.5ex]
  \footnotesize Each panel: 1D within-family MDS coordinate vs.\ one hyperparameter.
  \begin{itemize}
...
\begin{frame}{Within-family structure II --- \texttt{cs}\,/\,\texttt{tree}}
  \centering
  \includegraphics[width=0.82\textwidth]{../figures/hp_trajectories/hp_vs_mds1_cs_tree.pdf}\\[0.5ex]
  \footnotesize Same construction --- within-family MDS coordinate vs.\ \texttt{cp}, \texttt{minbucket}, \texttt{minsplit}.
  \begin{itemize}
